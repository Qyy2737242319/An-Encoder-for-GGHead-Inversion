...
def main(run_name: str,
         ...
         seeds: Optional[str] = "150",  # comma-separated list of seeds to sample from
    ...
    # poses = circle_around_axis(384, axis=Vec3(0, 1, 0), up=Vec3(0, 1, 0), move=Vec3(0, 0, 0),
    #                            distance=2.4 * move_z / 2.7,
    #                            theta_to=2 * np.pi)
    ...
    with torch.no_grad():
        for seed in tqdm(seeds):
            ...
            output_folder = f"./sampled_heads/{run_name}"
